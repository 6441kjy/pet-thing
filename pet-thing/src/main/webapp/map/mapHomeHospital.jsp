...
<%
	...
	String mapPage="loadMapHospital.jsp";  
...
<body>
	...
	<div class="map-wrap position-relative">
		...
		%>
		<li><a href="<%="?currentPage=mapHospital&hospitalItemNo="+hosItem.getNo()+"&hospitalItemName="+hosItem.getName()+"&x="+hosItem.getX()+"&y="+hosItem.getY() %>"
