...
<body>
	<center>
		<form action="<%=request.getContextPath()%>/map/reviewProc.jsp"
			method=post>
								...
								<tbody>
									...
									<tr>
										<th scope="row" style="line-height: 48px; height: 48px;">별점
											평가</th>
										<td class="align-middle"><select name="star-rating"
									...
									<tr>
										<th scope="row" style="line-height: 200px;">후기 내용</th>
										<td colspan="2" class="align-middle">
										<textarea name="review-contents" class="w-100" style="height:200px;" placeholder="후기를 등록해 주세요"></textarea>
										</td>
									</tr>
								</tbody>
							</table>
