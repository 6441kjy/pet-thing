...
<%
	...
	List<Board> boardLstHit2 = (List<Board>)session.getAttribute("boardLstHit2");
	String url = request.getContextPath()+"/community/boardProcBest.jsp?"+naviStrm+"&pageNumber=";
			...
			<div class="container commuNav">
				<nav class="navTop">
		    		<ul>
		    			...
		    			<li>
		    				<a href="<%=path %>" class="btn btn-outline-primary">Q&amp;A</a>
		    			</li>
		    		</ul>
		    	</nav>
			</div>
